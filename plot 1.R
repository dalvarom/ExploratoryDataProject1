...
# Set" which I have made available on the course web site:
#  
...
#8.Sub_metering_2: energy sub-metering No. 2 (in watt-hour of active energy). It corresponds to the laundry 
#  room, containing a washing-machine, a tumble-drier, a refrigerator and a light. 
#9.Sub_metering_3: energy sub-metering No. 3 (in watt-hour of active energy). It corresponds to an electric 
...
# 2007. Your task is to reconstruct the following plots below, all of which were constructed using the base 
# plotting system.
# 
...
# plot1.R constructs the plot1.png plot. Your code file should include code for reading the data so that the plot 
...
#Finally we save the plot as PDF
pdf (file="myplot.png")
hist(aux, col="red", main ="Global Active Power",xlab="Global Active Power (kilowatts)")
dev.off()

# Or save it as PNG as asked on the project
